...
export default class Trello {
  ...
  setObservers() {
    return [
      ...this.setConfigObservers(),
      ...this.setWorkspaceObservers()
    ]
  }
  ...
  loadCards() {
    ...
    this.api.getCardsOnList(in_progress).then((info) => {
      this.emitter.emit('did-change-cards', info);
    });
  }
}
