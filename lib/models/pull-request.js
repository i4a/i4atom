...
import GithubPullRequest, { ChangelogPath } from '../apis/github/pull-request'
...
export default class PullRequest {
  static async open (body) {
    const branchName = await i4atom.git.getCurrentBranchName()
    const title = branchName.replace(/-/g, ' ')
