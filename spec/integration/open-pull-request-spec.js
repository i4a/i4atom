...
describe('I4atom', () => {
  ...
  describe('open pull request', () => {
    it('works', () => {
      ...
      runs(() => {
        expect(atom.notifications.getNotifications()[0].getMessage()).toContain('<a href="https://github.com/thefrogs/thepond/pull/121">Title of pull request for card 121</a> opened and added to <a href="https://trello.card/121">Card with Pepe without PR</a>')
